...
public class MagneticField extends SuperDrawerActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sensorDescriptionTV.setText("Measures the ambient geomagnetic field for all three physical axes (x, y, z) in μT.");
    }
